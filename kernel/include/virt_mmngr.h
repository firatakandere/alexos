...
#define vmm_table_idx(flag) (page >> 12)
#define vmm_dir_idx(page) (page >> 22)

#define vmm_flush_tlb(page) asm volatile("invlpg (%0)" : : "a" (page & PAGE_MASK))

#define assert_higher(var) (var = (var > KERNEL_OFFSET)?(var):(var + KERNEL_OFFSET))
